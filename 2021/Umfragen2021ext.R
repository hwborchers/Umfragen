...
Umfragen = U[1:208, ]
Umfragen$Datum = as.Date(Umfragen$Datum)
...
# points(Umfragen$Datum, Umfragen$LINKE, pch = 20, col = "magenta")
fss <- supsmu(Umfragen$Datum, Umfragen$LINKE, bass = 0)
lines(fss$x, fss$y, col = "magenta", lwd = 2.0)

# points(Umfragen$Datum, Umfragen$AfD, pch = 20, col = "brown")
...
points(rep(as.Date("2021-01-01"), 6), pch = 22,
       c(32.9, 20.5, 8.9, 10.7, 12.6, 9.2),
       col = c("black", "red", "green3", "blue", "brown", "magenta"),
       bg =  c("black", "red", "green3", "blue", "brown", "magenta"))

points(rep(as.Date("2021-09-26"), 6), pch = 22,
       c(24.1, 25.7, 14.8, 11.5, 10.3, 4.9),
       col = c("black", "red", "green3", "blue", "brown", "magenta"),
       bg =  c("black", "red", "green3", "blue", "brown", "magenta"))
...
E = data.frame(Jahr = c(2017, 2021), CDU.CSU = c('32.9', '24.1'),
               SPD = c('20.5', '25.7'), Gruene = c('8.9', '14.8'),
               FDP = c('10.7', '11.5'), AfD = c('12.6', '10.3'),
               DieLinke = c('9.2', '4.9'), Sonstige = c('5.0', '8.7'))

plotrix::addtable2plot(x = as.Date("2021-04-01"), y = 33, E,
                       cex = 1.2, text.col = "gray40",
