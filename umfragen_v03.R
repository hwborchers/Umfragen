...
from = "2019-12-31"
to = "2025-02-28"  #today              # as.Date("2024-01-01")
...
plot(c(as.Date(from), as.Date(to)), c(0, 40), type = 'n',
     ylim = c(2, 40), main = "Umfragen 2020-24 (Sonntagsfrage)")
grid()
...
if (smoothing == "lowess") {
    ...
    mdl <- lowess(Umfragen$Datum, Umfragen$AfD, f = 1/12)
